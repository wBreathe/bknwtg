...
def run_main():
    ...
    finetune_model_path = os.path.join(os.path.abspath(os.getcwd()),"model_addnew0.5_pkldumptest_segbybinary","0EEEpoch003-train_loss-0.045-val_loss-1.438-domain_loss-0.000-train_cls_acc-0.984-val_cls_acc-0.655-domain_cls_acc-0.000.h5")
    finetune = True
    ...
    source_dataset_path = "/wangjuan/dann-tf/fintuned_ind_adddirect/base_fintuned_pos_adddirect.pkl"
    target_dataset_path = "/wangjuan/dann-tf/data_segbybinary_test/C_test_positive.pkl"
    ...
    cfg = config(embed_model_path = embed_model_path,
                 ...
                 finetune=False,
                 embed = True,
                 dir_name =os.path.abspath(os.path.abspath(os.getcwd())+"/model_seg_by_binary_fintuned_adddirect"),
    ...
    if(seqencetonum):
        ...
        x_train,y_train,x_val,y_val = split_dataset(source_dataset_path,cfg.seq_len,cfg.portion,1)
        #test
    else:
